...
<html lang="en" >
  <head>
    ...
    <!-- css -->
    <link rel="stylesheet" type="text/css" href="assets/stylesheets/promote.css?<?php echo time(); ?>">
  ...
  <body>
    ...
    <div class="jumbotron">
      <h1 class="display-4">Referral</h1>
    </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <h5><i class="fas fa-coins fa-warning" style="color: gold;"></i> 0.00</h3>
        <button type="button" class="btn btn-outline-warning claim-button">Claim</button>
      </div>
    </div>
  </div>
</div>
